...
Column {
    ...
    Item {
        ...
        TextField {
            ...
            background: Rectangle {
                color: "transparent"
                border.color: config.LoginFieldTextColor
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        color: Qt.darker(config.HighlightBackgroundColor, 1.1)
                        opacity: 1
                    }
                    PropertyChanges {
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground
                        color: Qt.lighter(config.HighlightBackgroundColor, 1.15)
                        opacity: 1
                    }
                    PropertyChanges {
                        target: loginButton.contentItem
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground
                        color: Qt.lighter(config.HighlightBackgroundColor, 1.2)
                        opacity: 1
                    }
                    PropertyChanges {
                        target: loginButton.contentItem
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground;
                        color: config.HighlightBackgroundColor;
                        opacity: 1
                    }
                    PropertyChanges {
                        target: loginButton.contentItem;
